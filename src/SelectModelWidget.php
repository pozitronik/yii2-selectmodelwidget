 ...
 * @todo: добавить перечисление допустимых режимов потомка, чтобы виджеты, не поддерживающие аяксовый поиск сообщали об этом
 * @todo: не работает в standalone-режиме, только при использовании с моделью
 */
